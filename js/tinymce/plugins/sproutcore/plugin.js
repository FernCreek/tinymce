...
(function () {
	...
	tinymce.create('tinymce.plugins.SproutCorePlugin', {
		...
		SproutCorePlugin: function (ed) { // eslint-disable-line no-unused-vars
			// Class Constructor
		},
		...
		init: function (ed) {
			...
			ed.addCommand('scOpenExpandedEditor', function (ui, value) { // eslint-disable-line no-unused-vars
			...
			ed.addCommand('mceLink', function (ui, value) { // eslint-disable-line no-unused-vars
			...
			ed.addCommand('mceImage', function (ui, value) { // eslint-disable-line no-unused-vars
	...
	tinymce.create('tinymce.SproutCoreWindowManager:tinymce.WindowManager', {
		...
		SproutCoreWindowManager: function (ed) {
			...
			// Overriding the open command so we can replace the default dialogs with SproutCore based dialogs.
		 ...
		 */
		_setupColorPicker: function (ed) { // eslint-disable-line no-unused-vars
		 ...
		 */
		_setupSourceEditorDialog: function (ed) { // eslint-disable-line no-unused-vars
